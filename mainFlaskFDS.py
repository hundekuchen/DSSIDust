...
def getDust():
       ...
       dtdiff = datetime.datetime.now()-dt
       if(dtdiff>datetime.timedelta(seconds = 200)):
          dt=datetime.datetime.now()
          #print('redohtmlgraph', dtdiff, file=sys.stderr)
          html_to_graph = gm.make_graph()  
       
       #print('dtdiff', dtdiff, file=sys.stderr)
       html_to_graph = gm.html_to_graph
       
       
       #print("html_graph_string", html_to_graph, file=sys.stderr)
       ...
       #testval = '30'
       #dust_data = [testval,testval,testval]
